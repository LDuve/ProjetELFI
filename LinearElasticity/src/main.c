...
//    geoSetDomainName(7,"Bottom");    //DIRICHLET_Y
    ...
    geoSetDomainName(2,"dessus");  //DIRICHLET_X
    geoSetDomainName(3,"droitDessus");    //DIRICHLET_Y
    geoSetDomainName(4,"dessusPetit");    //DIRICHLET_X
...
//
    ...
    double rho = 7.85e3; 
    double g   = 9.81;
    femProblem* theProblem = femElasticityCreate(theGeometry,E,nu,rho,g,PLANAR_STRAIN);  // PLANAR_STRAIN PLANAR_STRESS AXISYM
    femElasticityAddBoundaryCondition(theProblem,"dessus",DIRICHLET_X,0.0);
    femElasticityAddBoundaryCondition(theProblem,"dessusPetit",DIRICHLET_X,0.0);
    femElasticityAddBoundaryCondition(theProblem,"droitDessus",DIRICHLET_Y,0.0);
